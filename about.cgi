...
<div class="container">
	<div class="my-5">
		...
		<p class="">
			...
			You can check out my other projects on my <a href="https://github.com/rokcej">Github page</a>.
		</p>
	</div>
	<div class="my-5">
		...
		<p>
			...
			All the icons were provided by <a href="https://fontawesome.com/">Fontawesome</a>.
		</p>
	</div>
	<div class="my-5">
		<h1>Feedback</h1>
